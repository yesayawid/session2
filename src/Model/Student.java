...
public class Student {
    ...
    public String get_nim() { return _nim; }

    public void set_nim(String _nim) { this._nim = _nim; }
    ...
    public void set_period(int _period) {this._period = _period; }

    public Student(String _nim, String _class, String _address, String _phone, int _period) {
        this._nim = _nim;
        this._name = _name;
        this._class = _class;
